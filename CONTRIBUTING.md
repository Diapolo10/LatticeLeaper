# Contributing to the `LatticeLeaper` project
...
Since `LatticeLeaper` has very little to do beyond programming and testing,
...
[Issues]: https://github.com/Diapolo10/LatticeLeaper/issues
[Projects]: https://github.com/Diapolo10/LatticeLeaper/projects
